...
public abstract class Document {
	...
	public double getFleschScore() {
		/*
		 * System.out.println(); System.out.println("Num words: " +
		 * getNumWords()); System.out.println("Num syllables: " +
		 * getNumSyllables()); System.out.println("Num sentences: " +
		 * getNumSentences());
		 */
		double flesch = 0.0;
		double part1 = 206.835;
		double part2 = (double) getNumWords() / (double) getNumSentences();
		part2 *= 1.015;
		// System.out.println("Part 2: " + part2);
		double part3 = (double) getNumSyllables() / (double) getNumWords();
		part3 *= 84.6;
		// System.out.println("Part 3: " + part3);
		flesch = part1 - part2 - part3;
		return flesch;
	}
