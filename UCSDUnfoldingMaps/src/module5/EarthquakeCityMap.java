...
public class EarthquakeCityMap extends PApplet {
	...
	void hideAllClickedOnQuake() {
		...
		for (Marker marker : cityMarkers) {
			if (marker.getLocation().getDistance(lastClicked.getLocation()) >= ((EarthquakeMarker) lastClicked)
					.threatCircle()) {
				marker.setHidden(true);
			}
		}
	...
	void hideAllClickedOnCity() {
		for (Marker marker : quakeMarkers) {
			if (marker.getLocation().getDistance(lastClicked.getLocation()) >= ((EarthquakeMarker) marker)
					.threatCircle()) {
				marker.setHidden(true);
			}
		}
